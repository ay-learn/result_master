...
int main() {
  etudiant etudiant[MAX] = {
      ...
      {"ali",           10.00, 10.00, 10.00, 11.50, 10.00, 11.81},
      ...
      {"mina",          15.00, 10.00, 13.50, 13.00, 12.00, 19.27},
      ...
      {"fatima",        14.00, 10.00, 12.25, 15.50, 15.00, 18.78},
      {"youssef",       14.50, 12.00, 16.88, 14.50, 13.50, 19.72},
      {"hind",          14.50, 10.00, 15.00, 15.75, 12.50, 19.36},
